...
RUN apt-get install -qq zlib1g zlib1g-dev
RUN rm -rf /var/lib/apt/lists/*
RUN unset DEBIAN_FRONTEND

RUN wget -nv --directory-prefix=/ http://trueta.udg.edu/apt/ubuntu/devel/0.15/starviewer-sdk-linux-0.15-5.tar.xz
RUN mkdir /sdk-0.15
RUN tar xf /starviewer-sdk-linux-0.15-5.tar.xz -C /sdk-0.15
